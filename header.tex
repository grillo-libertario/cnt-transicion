...
\sectionfont{\clearpage\thispagestyle{inicioCapitulo}\normalfont\LARGE\itshape}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{images/#1-byn}
  \caption{#2}
\end{figure}
}


\newcommand{\fotoalalto}[2]{%
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.5\textwidth]{images/#1-byn}
  \caption{#2}
\end{figure}
}
